...
const About: React.FC = () => {
  ...
  return (
    <section
      id="about"
      className="py-16 bg-gradient-to-br from-white to-sky-50 dark:from-gray-900 dark:to-black relative overflow-hidden"
    >
          ...
          >
            <div className="card-gradient">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                Experienced developer specializing in modern web technologies. I
                create efficient, scalable applications with clean code and
                intuitive user interfaces.
              </p>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                Focused on delivering high-quality solutions that meet business
                requirements while maintaining excellent user experience and
