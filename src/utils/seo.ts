...
export const getProjectSEO = (projectId: string, projectTitle: string, projectDescription: string): SEOData => {
  return {
    ...
    image: "https://heetviradiya.codes/og-image.jpg",
    url: `https://heetviradiya.codes/projects/${projectId}`,
    type: "article",
    author: "Heet Viradiya",
    section: "Projects",
...
export const getPageSEO = (page: string): SEOData => {
  const seoData: Record<string, SEOData> = {
    ...
    projects: {
      ...
      image: "https://heetviradiya.codes/og-image.jpg",
      url: "https://heetviradiya.codes/projects",
      type: "website",
      author: "Heet Viradiya"
    },
    about: {
    ...
    skills: {
      ...
      image: "https://heetviradiya.codes/og-image.jpg",
      url: "https://heetviradiya.codes/#skills",
      type: "website",
      author: "Heet Viradiya"
    },
    experience: {
      ...
      image: "https://heetviradiya.codes/og-image.jpg",
      url: "https://heetviradiya.codes/#experience",
      type: "website",
      author: "Heet Viradiya"
    },
    contact: {
      ...
      image: "https://heetviradiya.codes/og-image.jpg",
      url: "https://heetviradiya.codes/#contact",
      type: "website",
      author: "Heet Viradiya"
    }
  };
...
export const generateWebsiteStructuredData = () => {
  return {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://heetviradiya.codes/search?q={search_term_string}",
...
export const generateProjectStructuredData = (project: any) => {
  return {
    ...
    "url": `https://heetviradiya.codes/projects/${project.id}`,
    "image": project.image,
    "author": {
      "@type": "Person",
      "name": "Heet Viradiya"
